...
- [Milanote](/tools/milanote/) passt zu stärker präsentations- und moodboardorientierter kreativer Planung.
- [Miro](/tools/miro/) ist besser für Workshops und synchrones Whiteboarding mit vielen Beteiligten.
- [FigJam](/tools/figjam/) eignet sich für Designteams, die Recherche direkt mit gemeinsamer Ideation verbinden wollen.
- [Obsidian](/tools/obsidian/) ist eine Alternative für lokale, textorientierte Wissensnetze mit Dateien unter eigener Kontrolle.
- [Eagle](/tools/eagle/) passt, wenn der Schwerpunkt auf dem lokalen Verwalten großer visueller Asset-Sammlungen liegt.
