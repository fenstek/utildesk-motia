...
- [Anki](/tools/anki/): Besonders flexibel für eigene Karten, Plugins und lokale Kontrolle über den Lernbestand.
- [Memrise](/tools/memrise/): Sinnvoll, wenn Sprachlernen mit kurzen Übungen, Aussprache und kursartigem Material im Vordergrund steht.
- [Duolingo](/tools/duolingo/): Eher geeignet für geführte Sprachlektionen mit motivierender täglicher Routine als für frei modellierte Fachdecks.
- [Babbel](/tools/babbel/): Gute Alternative für strukturierte Sprachkurse mit Dialogen und einem stärker vorgegebenen Lernpfad.
- [Cram](/tools/cram/): Einfacher Karteikarten-Dienst, wenn ein unkomplizierter Deck-Workflow wichtiger ist als ein umfassendes Lernökosystem.
