...
<figure class="tool-editorial-figure">
  <img src="/images/tools/dominknow-one-editorial.webp" alt="Instructional Designer planen responsive Lernseiten, Simulationen und wiederverwendbare Inhaltsbausteine auf einer Studiobühne" loading="lazy" decoding="async" />
</figure>
...
- [Articulate 360](/tools/articulate-360/): Breite Suite für Storyline- und Rise-Kurse, wenn ein etabliertes Authoring-Ökosystem wichtiger ist als ein zentraler LCMS-Ansatz.
- [Adobe Captivate](/tools/adobe-captivate/): Geeignet für interaktive Kurse und Simulationen, wenn ein stärker desktop-orientierter Authoring-Workflow passt.
- [Elucidat](/tools/elucidat/): Cloudbasierte Zusammenarbeit und Skalierung für Teams, die responsive Inhalte mit einem fokussierten Editor erstellen wollen.
- [Lectora](/tools/lectora/): Eine Alternative für Projekte, bei denen Accessibility, Standards und detaillierte Kurskontrolle besonders wichtig sind.
- [iSpring Suite](/tools/ispring-suite/): Ein pragmatischerer Weg von PowerPoint zu LMS-Kursen für kleinere oder weniger komplexe Produktionsprozesse.
