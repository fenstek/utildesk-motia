...
- [Figma](/tools/figma/): die bessere erste Wahl fuer kollaboratives UI-Design, schnelle Prototypen und gemeinsames Arbeiten im Browser.
- [Sketch](/tools/sketch/): passend fuer macOS-zentrierte UI-Arbeit, wenn die Designbibliothek und der native Workflow wichtiger sind als sehr tiefe Zustandslogik.
- [Balsamiq](/tools/balsamiq/): sinnvoll fuer fruehe, bewusst grobe Wireframes, bei denen Diskussion wichtiger ist als realistische Interaktion.
- [Whimsical](/tools/whimsical/): gut fuer schnelle Flows, Diagramme und leichtgewichtige Abstimmungen, nicht fuer Axures komplexe Interaktionssimulation.
