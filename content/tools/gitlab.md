...
- [CircleCI](/tools/circleci/): wenn CI/CD bewusst als eigenständiger Spezialdienst laufen soll.
- [Jira](/tools/jira/): wenn Projektsteuerung außerhalb der DevSecOps-Plattform bleiben soll.
