...
- [Adobe Captivate](/tools/adobe-captivate/): Gute Wahl für responsive E-Learning- und Simulationserstellung, wenn Adobe-Workflows und ein anderer Authoring-Ansatz besser passen.
- [iSpring Suite](/tools/ispring-suite/): Sinnvoll für PowerPoint-nahe Kurserstellung, wenn Fachexperten schnell aus Präsentationen heraus arbeiten sollen.
- [H5P](/tools/h5p/): Passt zu web- und LMS-nahen interaktiven Lernbausteinen, wenn offene Inhalte und kleinere Interaktionstypen wichtiger sind als Storylines komplexer Desktop-Projekte.
- [Camtasia](/tools/camtasia/): Die passendere Option für Screen Recording und lineare Tutorialvideos, wenn keine verzweigte Kurslogik benötigt wird.
