...
description: "Desktop-RAW-Editor für präzise Korrekturen, DxO-Kamera- und Objektivmodule sowie DeepPRIME-Rauschreduzierung ohne laufendes Abonnement."
popularity: 0
tier: "D"
...
<figure class="tool-editorial-figure">
  <img src="/images/tools/dxo-photolab-editorial.webp" alt="Fotograf arbeitet an RAW-Aufnahmen in einer digitalen Dunkelkammer mit Vorschau und Korrekturreglern" loading="lazy" decoding="async" />
</figure>
...
1. Lege ein Testset aus echten RAWs an: schwieriges Gegenlicht, hohe ISO, Hauttöne und eine Architekturaufnahme.
2. Prüfe vorab die Kamera- und Objektivunterstützung und definiere einen neutralen Ausgangspreset.
3. Korrigiere zuerst Optik, Weißabgleich, Belichtung und Rauschen; nutze lokale Masken nur dort, wo der Bildinhalt es verlangt.
4. Vergleiche die Ergebnisse bei 100 Prozent und in der späteren Zielgröße. Exportiere danach klar benannte TIFF-, JPEG- oder DNG-Varianten mit eingebettetem Farbprofil.
5. Übergib Auswahl, Export und offene Entscheidungen an die nächste Person. PhotoLab ist kein Ersatz für ein gemeinsames Freigabe- oder Archivsystem.
...
- [Adobe Lightroom](/tools/adobe-lightroom/): Breiterer Katalog- und Cloud-Workflow mit Abo-Modell; passend für synchronisierte Bibliotheken und teamnahe Übergaben.
- [Capture One](/tools/capture-one/): Starke Farbsteuerung und Tethering für Studios, wenn Aufnahme, Auswahl und Farblook eng verbunden sind.
- [darktable](/tools/darktable/): Kostenfreie Open-Source-RAW-Verarbeitung, wenn lokale Kontrolle und ein anderes Lizenzmodell wichtiger sind als DxO-Module.
- RawTherapee: Technisch detaillierter RAW-Konverter für Einzelbilder und experimentelle Verarbeitung ohne kommerzielle Lizenz.
- [ON1 Photo RAW](/tools/on1-photo-raw/): Kombiniert RAW-Bearbeitung und Verwaltung stärker in einem Paket, wenn PhotoLab als alleiniger Editor zu schmal ist.
