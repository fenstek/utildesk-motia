...
- [Milestone Systems](/tools/milestone-systems/) ist eine verbreitete VMS-Alternative mit Integrationsfokus.
- [Verkada](/tools/verkada/) verfolgt einen stärker cloudorientierten Sicherheitsansatz.
- [Axis Camera Station](/tools/axis-camera-station/) passt insbesondere zu Axis-Kameraumgebungen.
- [Genetec Clearance](/tools/genetec-clearance/) unterstützt andere, stärker fall- und beweisorientierte Video-Workflows.
- [Axis Communications](/tools/axis-communications/) ist relevant, wenn Kamera-Hardware und VMS gemeinsam bewertet werden.

## FAQ

**Ist ACC nur für Avigilon-Kameras?**
Die VMS-Linie unterstützt auch Integrationen, aber konkrete Kompatibilität und Funktionen müssen für Kamera, Lizenz und Version geprüft werden.

**Darf man Gesichtssuche einfach einschalten?**
Nein. Biometrische Verarbeitung braucht eine standortbezogene rechtliche und organisatorische Prüfung.

**Wie verhindert man Alarmflut?**
Mit wenigen klaren Alarmregeln, Tests, Zuständigkeiten und einer laufenden Messung von Fehlalarmen.

**Was gehört zu einem sauberen Videofall?**
Zeitstempel, Quelle, Bearbeiter, Entscheidung, Exportkette und eine definierte Aufbewahrungs- oder Löschregel.
