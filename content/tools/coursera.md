...
<figure class="tool-editorial-figure">
  <img src="/images/tools/coursera-editorial.webp" alt="Illustration zu Coursera: Lernpfad aus Kursmaterialien, Vorlesungsbühne und Notizen" loading="lazy" decoding="async" />
</figure>
...
- [edX](/tools/edx/): geeigneter, wenn Hochschulkurse, MicroMasters und die akademische Einordnung des Angebots im Vordergrund stehen.
- [Udemy](/tools/udemy/): flexibler für einzelne, oft günstig einzeln gekaufte Kurse, mit stärker schwankender Qualität zwischen den Dozenten.
- [DataCamp](/tools/datacamp/): fokussierter auf interaktive Übungen für Python, SQL, Datenanalyse und Data Science als auf ein breites Hochschul- und Karriereportfolio.
- [Pluralsight](/tools/pluralsight/): passender für technische Skill-Pfade, Assessments und Labs in Softwareentwicklung, Cloud, IT und Security.
- [Khan Academy](/tools/khan-academy/): sinnvoll für kostenloses Grundlagenlernen, besonders bei Mathematik und schulnahen Themen, nicht für formale Berufszertifikate.
