...
<figure class="tool-editorial-figure">
  <img src="/images/tools/eagle-editorial.webp" alt="Zwei Kreative sichten und ordnen visuelle Referenzen in einem Archivraum" loading="lazy" decoding="async" />
</figure>
...
- [Adobe Lightroom](/tools/adobe-lightroom/): Bessere Wahl, wenn Fotografen neben Bibliotheksfunktionen auch eine ausgereifte Bildentwicklung, Katalogpflege und Foto-Workflow benötigen.
- [Affinity Designer](/tools/affinity-designer/): Passt, wenn aus Referenzen direkt Vektorillustrationen, Layouts und editierbare Designdateien entstehen sollen.
- [Figma](/tools/figma/): Sinnvoller für browserbasierte Produktteams, die gemeinsam an UI-Dateien, Prototypen, Kommentaren und Designsystemen arbeiten.
- [Are.na](/tools/are-na/): Geeignet für kuratierte Recherche-Channels mit Links, Bildern und Textblöcken statt einer lokalen Produktionsbibliothek.
- [Obsidian](/tools/obsidian/): Bietet sich an, wenn Notizen, Quellenverbindungen und Markdown-Wissen wichtiger sind als Medienvorschau und Asset-Import.
