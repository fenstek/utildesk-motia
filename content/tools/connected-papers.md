...
<figure class="tool-editorial-figure">
  <img src="/images/tools/connected-papers-editorial.webp" alt="Forschende ordnen ein verbundenes Netz aus wissenschaftlichen Arbeiten und Zitierbeziehungen" loading="lazy" decoding="async" />
</figure>
...
- [Semantic Scholar](/tools/semantic-scholar/): Bietet eine breitere wissenschaftliche Suche und Metadatenbasis, wenn zuerst einzelne Papers, Autoren oder Themen systematisch gefunden werden sollen.
- [Litmaps](/tools/litmaps/): Eignet sich besser für fortlaufendes Monitoring und Zitationskarten, wenn neue Publikationen über einen längeren Zeitraum verfolgt werden sollen.
- [Google Scholar](/tools/google-scholar/): Ist die pragmatische Ergänzung für eine sehr breite Websuche nach Artikeln, Büchern, Dissertationen und Zitationen.
- [Consensus](/tools/consensus/): Passt, wenn eine Forschungsfrage über Evidenzzusammenfassungen vorbereitet und anschließend an den Studien geprüft werden soll.
- [scite](/tools/scite/): Ist sinnvoll, wenn nicht nur Verbindungen, sondern auch der Kontext und die Art späterer Zitationen untersucht werden sollen.
