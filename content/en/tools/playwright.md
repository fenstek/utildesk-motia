...
description: 'Playwright is a modern open-source tool designed for browser automation and testing web applications. It enables developers to write and execute reliable end-to-end tests across multiple browsers. Supporting Chromium, Firefox, and WebKit, Playwright offers a powerful API tailored for developing robust and maintainable tests.'
translation: full
---
# Playwright
