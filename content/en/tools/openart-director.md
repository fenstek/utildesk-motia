...
1. An idea, campaign message, or storyline is captured in concise form.
2. Visual directions, scene sequences, or style variants are derived from it.
3. The team generates several short drafts to compare tone and impact.
4. The best variant is selected and aligned internally.
5. After that, either refinement continues directly in the tool or the material is handed off to other tools for editing, audio, or final delivery.
...
The official site is the most reliable starting point here:
👉 **To the provider:** https://openart.ai/whats-new
