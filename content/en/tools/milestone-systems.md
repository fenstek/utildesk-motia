...
description: "Milestone Systems is a business and operations platform for video management and security infrastructure for professional surveillance and site systems."
translation: full
---
# Milestone Systems
...
## Alternatives to Milestone Systems

- [Avigilon](/en/tools/avigilon/): useful comparison point if workflow, pricing, or specialization should differ.
- [Axis Communications](/en/tools/axis-communications/): useful comparison point if workflow, pricing, or specialization should differ.
- Genetec: useful comparison point if workflow, pricing, or specialization should differ.
- [BriefCam](/en/tools/briefcam/): useful comparison point if workflow, pricing, or specialization should differ.
