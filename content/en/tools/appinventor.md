...
- **Thunkable**: Another visual development platform with an extended feature set and support for both Android and iOS.
- **Kodular**: Similar to AppInventor, but with additional components and a larger community.
