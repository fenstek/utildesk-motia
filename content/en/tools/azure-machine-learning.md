...
popularity: 0
description: 'A cloud-based Microsoft platform for building, training, deploying, and managing machine-learning models across the full AI project lifecycle.'
translation: full
---
...
<figure class="tool-editorial-figure">
  <img src="/images/tools/azure-machine-learning-editorial.webp" alt="Illustration for Azure Machine Learning: data, training, model review and deployment as a laboratory landscape" loading="lazy" decoding="async" />
</figure>
...
- **Google Cloud AI Platform:** Cloud-based machine-learning platform with comprehensive tools for model training and deployment.
- **Amazon SageMaker:** AWS service for rapid development, training, and deployment of machine-learning models.
- [IBM Watson Studio](/tools/ibm-watson-studio/): Platform for collaboration on data science and AI projects with a focus on automation.
- [Databricks](/tools/databricks/): Platform for big data and AI that offers Spark integration and collaborative development.
- [H2O.ai](/tools/h2o-ai/): Open-source and cloud-based platform for automated machine learning.
