...
sidebarPoints:
  - "Technical SEO answers whether Google can process a page. Editorial quality answers why the page should exist."
  - "New tool directories need visible experience, clear selection criteria, and maintained topical hubs."
relatedTools:
...
- [Google Search Console](/tools/google-search-console/) - the core place to inspect crawling, indexing, and search-performance signals.
- [Claude](/tools/claude/) - useful when editorial and research workflows need AI assistance.
- [GitHub Copilot](/tools/github-copilot/) - a reference point for AI support inside development work.
- [Cursor](/tools/cursor/) - relevant when tool evaluation is tied to IDE-based workflows.
- [Aider](/tools/aider/) - for teams that prefer Git-adjacent AI coding sessions.
- [LangChain](/tools/langchain/) - when the directory topic touches orchestration and agent infrastructure.
...
1. a clear test method,
2. own screenshots or reproducible workflow examples,
3. concrete limits and counterindications,
4. pricing and privacy notes,
5. comparison with real alternatives,
...
1. Which pages contain original experience or analysis?
2. Which pages are vendor paraphrases?
3. Which categories match clear user intent?
4. Which tools should be merged, archived, or marked as not yet reviewed?
5. Which internal links actually help the reader move forward?
...
1. **Segment Search Console signals:** Look for patterns by page type, not only by individual URL: tool pages, categories, guides, and comparison pages.
2. **Merge thin pages:** Consolidate entries that contain no original experience or analysis instead of keeping them artificially indexable.
3. **Show methodology:** Explain per category how tools are evaluated and which criteria matter.
4. **Build hubs:** Connect individual tool pages to real workflow and comparison pages.
5. **Document freshness:** Add review dates and change notes, especially for pricing, privacy, and integrations.
6. **Validate structured data:** Markup should describe visible content, not pretend editorial depth exists.
...
3. [Spam policies for Google web search](https://developers.google.com/search/docs/essentials/spam-policies)
4. [Sitemaps overview](https://developers.google.com/search/docs/crawling-indexing/sitemaps/overview)
5. [Introduction to robots.txt](https://developers.google.com/search/docs/crawling-indexing/robots/intro)
6. [Get started with Search Console](https://developers.google.com/search/docs/monitor-debug/search-console-start)
7. [Intro to structured data markup](https://developers.google.com/search/docs/appearance/structured-data/intro-structured-data)
8. [Updating our site reputation abuse policy](https://developers.google.com/search/blog/2024/11/site-reputation-abuse)
9. [Ranking incidents history](https://status.search.google.com/products/rGHU1u87FJnkP6W2GwMi/history)
10. [Bing Webmaster Guidelines](https://www.bing.com/webmasters/help/webmaster-guidelines-30fba23a)
11. [IndexNow](https://www.bing.com/webmasters/help/indexnow-7f2a3e3f)
12. [Crawled - currently not indexed discussion](https://support.google.com/webmasters/thread/433897163/google-index-crawled-%E2%80%93-currently-not-indexed?hl=en)
